...
There is somewhat overlap from data transformation here, where the necessary alterations regarding data modeling force structure that aims to maintain integrity and model operatability. For example, for the iterated WLS-regressions, it is much easier to load 12 time-series features and turn them into 1 707 cross-sections in program rather, than creating 1 707 seperate cross-sections as individual files. 
